...
const zh_cn = {
  ...
  ConfirmBan: '确认封锁',
  Unban: '解除封禁',
  UnbanPlayerTitle: '解除封禁 ${1}',
  UnbanDesc: '解除封禁 ${1}，允许其重新加入服务器。',
  SaveWorldNow: '立即存档',
  SaveWorldNowDesc: '通过 REST API 触发立即世界存档。',
  SaveWorldDone: '世界存档成功。',
  Save: '保存',
  Send: '发送',
  ...
  WorkerThreads: '工作线程数',
  WorkerThreadsDesc: '服务器工作线程数量 (1-128)。留空使用默认值。',
  ...
  PvPSettings: 'PvP 设定',
  bEnableFastTravelOnlyBaseCamp: '仅限据点快速旅行',
  bAllowEnhanceStat_Attack: '允许强化攻击属性',
  bAllowEnhanceStat_Health: '允许强化生命属性',
  bAllowEnhanceStat_Stamina: '允许强化体力属性',
  bAllowEnhanceStat_Weight: '允许强化负重属性',
  bAllowEnhanceStat_WorkSpeed: '允许强化工作速度属性',
  bCharacterRecreateInHardcore: '硬核模式角色重建',
  BlockRespawnTime: '重生封锁时间（秒）',
  RespawnPenaltyDurationThreshold: '重生惩罚持续时间阈值',
  RespawnPenaltyTimeScale: '重生惩罚时间倍率',
  GuildRejoinCooldownMinutes: '公会重新加入冷却（分钟）',
  ...
  AdditionalDropItemWhenPlayerKillingInPvPMode_ItemAndEquipment: '物品和装备',
  AdditionalDropItemWhenPlayerKillingInPvPMode_All: '全部',
  AdditionalDropItemNumWhenPlayerKillingInPvPMode: 'PvP 击杀掉落数量',
  bDisplayPvPItemNumOnWorldMap_BaseCamp: '地图显示 PvP 物品（据点）',
  bDisplayPvPItemNumOnWorldMap_Player: '地图显示 PvP 物品（玩家）',
  bAllowClientMod: '允许客户端模组',
  ChatPostLimitPerMinute: '每分钟聊天消息限制',
  LogFormatType: '日志格式',
  LogFormatType_Text: '文本',
  LogFormatType_Json: 'Json',
  ItemContainerForceMarkDirtyInterval: '容器同步间隔',
  DenyTechnologyList: '禁用科技列表',
  DenyTechnologyListPlaceholder: '输入以逗号分隔的科技 ID',
  // PalDefender Commands
  WhitelistAdd: '添加到白名单',
  WhitelistAddDesc: '将 ${1} 添加到服务器白名单',
  RenamePlayer: '重命名玩家',
  RenamePlayerDesc: '更改 ${1} 的名称',
  TeleportPlayer: '传送玩家',
  TeleportPlayerDesc: '将 ${1} 传送到另一位玩家',
  GodMode: '无敌模式',
  GodModeDesc: '切换 ${1} 的无敌模式',
  ClearInventory: '清空背包',
  ClearInventoryDesc: '清空 ${1} 背包中的所有物品',
  ClearInventoryConfirm: '确定要清空背包吗？',
  DeletePals: '删除帕鲁',
  DeletePalsDesc: '删除 ${1} 的所有帕鲁',
  DeletePalsConfirm: '确定要删除所有帕鲁吗？',
  LearnTech: '学习科技',
  LearnTechDesc: '为 ${1} 解锁一项科技',
  SpawnPal: '生成帕鲁',
  SpawnPalDesc: '为 ${1} 生成一只帕鲁',
  GiveEgg: '给予蛋',
  GiveEggDesc: '给予 ${1} 一颗帕鲁蛋',
  ReloadConfig: '重新加载配置',
  ReloadConfigDesc: '重新加载 PalDefender 配置',
  AddAdminIP: '添加管理员 IP',
  PgBroadcast: 'PalGuard 广播',
  WhitelistManagement: '白名单管理',
  WhitelistManagementDesc: '管理 PalDefender 白名单。仅白名单中的玩家可以加入服务器。',
