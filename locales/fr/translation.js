...
const fr = {
  ...
  UnbanPlayerTitle: 'Lever le ban de ${1}',
  UnbanDesc: 'Lever le bannissement de ${1}, lui permettant de rejoindre le serveur.',
  SaveWorldNow: 'Sauvegarder le monde maintenant',
  SaveWorldNowDesc: 'Déclencher une sauvegarde immédiate via l\'API REST.',
  SaveWorldDone: 'Monde sauvegardé avec succès.',
  Save: 'Sauvegarder',
  ...
  WorkerThreads: 'Threads de travail',
  WorkerThreadsDesc: 'Nombre de threads de travail pour le serveur (1-128). Laisser vide pour la valeur par défaut.',
  RESTAPIEnabledDesc:
  ...
  // PvP & New World Settings
  PvPSettings: 'Paramètres PvP',
  bEnableFastTravelOnlyBaseCamp: 'Voyage rapide uniquement au camp de base',
  ...
  bCharacterRecreateInHardcore: 'Recréation du personnage en Hardcore',
  BlockRespawnTime: 'Temps de blocage de réapparition (secondes)',
  ...
  GuildRejoinCooldownMinutes: 'Temps de recharge pour rejoindre la guilde (minutes)',
  MaxBuildingLimitNum: 'Limite maximale de bâtiments',
  EquipmentDurabilityDamageRate: "Taux de dégâts de durabilité d'��quipement",
  ItemCorruptionMultiplier: 'Multiplicateur de corruption des objets',
  ItemWeightRate: 'Taux de poids des objets',
  bAdditionalDropItemWhenPlayerKillingInPvPMode: 'Drop additionnel en PvP',
  AdditionalDropItemWhenPlayerKillingInPvPMode: 'Type de drop PvP',
  AdditionalDropItemWhenPlayerKillingInPvPMode_None: 'Aucun',
  AdditionalDropItemWhenPlayerKillingInPvPMode_Item: 'Objets',
  AdditionalDropItemWhenPlayerKillingInPvPMode_ItemAndEquipment: 'Objets et équipement',
  AdditionalDropItemWhenPlayerKillingInPvPMode_All: 'Tout',
  AdditionalDropItemNumWhenPlayerKillingInPvPMode: 'Quantité de drop PvP',
  bDisplayPvPItemNumOnWorldMap_BaseCamp: 'Afficher objets PvP sur carte (Camp)',
  bDisplayPvPItemNumOnWorldMap_Player: 'Afficher objets PvP sur carte (Joueur)',
  bAllowClientMod: 'Autoriser les mods client',
  ChatPostLimitPerMinute: 'Limite de messages chat par minute',
  LogFormatType: 'Format de log',
  LogFormatType_Text: 'Texte',
  LogFormatType_Json: 'Json',
  ItemContainerForceMarkDirtyInterval: 'Intervalle de synchronisation des conteneurs',
  DenyTechnologyList: 'Liste des technologies interdites',
  DenyTechnologyListPlaceholder: 'Entrez les IDs de technologies séparés par des virgules',
  // PalDefender Commands
  WhitelistAdd: 'Ajouter à la liste blanche',
  WhitelistAddDesc: 'Ajouter ${1} à la liste blanche du serveur',
  RenamePlayer: 'Renommer le joueur',
  RenamePlayerDesc: 'Changer le nom de ${1}',
  TeleportPlayer: 'Téléporter le joueur',
  TeleportPlayerDesc: 'Téléporter ${1} vers un autre joueur',
  GodMode: 'Mode Dieu',
  GodModeDesc: 'Activer/désactiver le mode dieu pour ${1}',
  ClearInventory: "Vider l'inventaire",
  ClearInventoryDesc: "Vider tous les objets de l'inventaire de ${1}",
  ClearInventoryConfirm: "Êtes-vous sûr de vouloir vider l'inventaire ?",
  DeletePals: 'Supprimer les Pals',
  DeletePalsDesc: 'Supprimer tous les Pals de ${1}',
  DeletePalsConfirm: 'Êtes-vous sûr de vouloir supprimer tous les Pals ?',
  LearnTech: 'Apprendre une technologie',
  LearnTechDesc: 'Débloquer une technologie pour ${1}',
  SpawnPal: 'Faire apparaître un Pal',
  SpawnPalDesc: 'Faire apparaître un Pal pour ${1}',
  GiveEgg: 'Donner un œuf',
  GiveEggDesc: 'Donner un œuf de Pal à ${1}',
  ReloadConfig: 'Recharger la configuration',
  ReloadConfigDesc: 'Recharger la configuration PalDefender',
  AddAdminIP: "Ajouter une IP d'administrateur",
  PgBroadcast: 'Diffusion PalGuard',
  WhitelistManagement: 'Gestion de la liste blanche',
  WhitelistManagementDesc:
    'Gérer la liste blanche PalDefender. Seuls les joueurs de la liste blanche peuvent rejoindre le serveur.',
  WhitelistEmpty: 'La liste blanche est vide',
  Add: 'Ajouter',
  Save: 'Enregistrer',
  SaveSuccess: 'Paramètres enregistrés avec succès',
  NewName: 'Nouveau nom',
  PalLevel: 'Niveau du Pal',
  TechId: 'ID de technologie',
  AdminIP: "Adresse IP de l'administrateur",
  Back: 'Retour',
  SearchItem: 'Rechercher des objets . . .',
  SearchPal: 'Rechercher un Pal . . .',
};
export default fr;
