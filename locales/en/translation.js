...
const en = {
  ...
  UnBan: 'Unban',
  Unban: 'Unban',
  UnbanPlayerTitle: 'Unban ${1}',
  UnbanDesc: 'Unban ${1}, allowing them to rejoin the server.',
  SaveWorldNow: 'Save World Now',
  SaveWorldNowDesc: 'Trigger an immediate world save via REST API.',
  SaveWorldDone: 'World saved successfully.',
  Save: 'Save',
  Dashboard: 'Dashboard',
  Setting: 'Settings',
  RAM: 'RAM',
  ...
  WorkerThreadsDesc: 'Number of worker threads for the server (1-128). Leave empty for default.',
  RESTAPIEnabledDesc:
  ...
  PvPSettings: 'PvP Settings',
  bEnableFastTravelOnlyBaseCamp: 'Fast Travel Only Base Camp',
  bAllowEnhanceStat_Attack: 'Allow Enhance Attack Stat',
  bAllowEnhanceStat_Health: 'Allow Enhance Health Stat',
  bAllowEnhanceStat_Stamina: 'Allow Enhance Stamina Stat',
  bAllowEnhanceStat_Weight: 'Allow Enhance Weight Stat',
  bAllowEnhanceStat_WorkSpeed: 'Allow Enhance Work Speed Stat',
  bCharacterRecreateInHardcore: 'Character Recreate in Hardcore',
  BlockRespawnTime: 'Block Respawn Time (seconds)',
  ...
  MaxBuildingLimitNum: 'Max Building Limit',
  ...
  bAdditionalDropItemWhenPlayerKillingInPvPMode: 'Additional Drop Item in PvP Kill',
  AdditionalDropItemWhenPlayerKillingInPvPMode: 'PvP Kill Drop Type',
  AdditionalDropItemWhenPlayerKillingInPvPMode_None: 'None',
  AdditionalDropItemWhenPlayerKillingInPvPMode_Item: 'Item',
  AdditionalDropItemWhenPlayerKillingInPvPMode_ItemAndEquipment: 'Item and Equipment',
  AdditionalDropItemWhenPlayerKillingInPvPMode_All: 'All',
  AdditionalDropItemNumWhenPlayerKillingInPvPMode: 'PvP Kill Drop Amount',
  bDisplayPvPItemNumOnWorldMap_BaseCamp: 'Display PvP Item on Map (Base Camp)',
  bDisplayPvPItemNumOnWorldMap_Player: 'Display PvP Item on Map (Player)',
  bAllowClientMod: 'Allow Client Mod',
  ChatPostLimitPerMinute: 'Chat Post Limit Per Minute',
  LogFormatType: 'Log Format Type',
  LogFormatType_Text: 'Text',
  LogFormatType_Json: 'Json',
  ItemContainerForceMarkDirtyInterval: 'Item Container Sync Interval',
  DenyTechnologyList: 'Deny Technology List',
  DenyTechnologyListPlaceholder: 'Enter technology IDs separated by commas',
  // PalDefender Commands
  WhitelistAdd: 'Add to Whitelist',
  WhitelistAddDesc: 'Add ${1} to the server whitelist',
  RenamePlayer: 'Rename Player',
  RenamePlayerDesc: 'Change the name of ${1}',
  TeleportPlayer: 'Teleport Player',
  TeleportPlayerDesc: 'Teleport ${1} to another player',
  GodMode: 'God Mode',
  GodModeDesc: 'Toggle god mode for ${1}',
  ClearInventory: 'Clear Inventory',
  ClearInventoryDesc: 'Clear all items from ${1} inventory',
  ClearInventoryConfirm: 'Are you sure you want to clear the inventory?',
  DeletePals: 'Delete Pals',
  DeletePalsDesc: 'Delete all Pals of ${1}',
  DeletePalsConfirm: 'Are you sure you want to delete all Pals?',
  LearnTech: 'Learn Technology',
  LearnTechDesc: 'Unlock a technology for ${1}',
  SpawnPal: 'Spawn Pal',
  SpawnPalDesc: 'Spawn a Pal for ${1}',
  GiveEgg: 'Give Egg',
  GiveEggDesc: 'Give a Pal Egg to ${1}',
  ReloadConfig: 'Reload Config',
  ReloadConfigDesc: 'Reload PalDefender configuration',
  AddAdminIP: 'Add Admin IP',
  PgBroadcast: 'PalGuard Broadcast',
  WhitelistManagement: 'Whitelist Management',
  WhitelistManagementDesc:
    'Manage PalDefender whitelist. Only whitelisted players can join the server.',
  ...
  AdminIP: 'Admin IP Address',
  Back: 'Back',
  SearchItem: 'Search items . . .',
  SearchPal: 'Search Pal . . .',
};
export default en;
