...
const zh_tw = {
  ...
  ConfirmBan: ' 確認封鎖',
  Unban: '解除封鎖',
  UnbanPlayerTitle: '解除封鎖 ${1}',
  UnbanDesc: '解除封鎖 ${1}，允許其重新加入伺服器。',
  SaveWorldNow: '立即存檔',
  SaveWorldNowDesc: '透過 REST API 觸發立即世界存檔。',
  SaveWorldDone: '世界存檔成功。',
  Save: '儲存',
  Send: '送出',
  ...
  WorkerThreadsDesc: '伺服器工作執行緒數量 (1-128)。留空使用預設值。',
  ...
  PvPSettings: 'PvP 設定',
  bEnableFastTravelOnlyBaseCamp: '僅限據點快速旅行',
  bAllowEnhanceStat_Attack: '允許強化攻擊屬性',
  bAllowEnhanceStat_Health: '允許強化生命屬性',
  bAllowEnhanceStat_Stamina: '允許強化體力屬性',
  bAllowEnhanceStat_Weight: '允許強化負重屬性',
  bAllowEnhanceStat_WorkSpeed: '允許強化工作速度屬性',
  bCharacterRecreateInHardcore: '硬核模式角色重建',
  BlockRespawnTime: '重生封鎖時間（秒）',
  RespawnPenaltyDurationThreshold: '重生懲罰持續時間閾值',
  RespawnPenaltyTimeScale: '重生懲罰時間倍率',
  GuildRejoinCooldownMinutes: '公會重新加入冷卻（分鐘）',
  MaxBuildingLimitNum: '最大建築數量限制',
  EquipmentDurabilityDamageRate: '裝備耐久損耗倍率',
  ItemCorruptionMultiplier: '物品腐敗倍率',
  ItemWeightRate: '物品重量倍率',
  bAdditionalDropItemWhenPlayerKillingInPvPMode: 'PvP 擊殺額外掉落',
  AdditionalDropItemWhenPlayerKillingInPvPMode: 'PvP 擊殺掉落類型',
  AdditionalDropItemWhenPlayerKillingInPvPMode_None: '無',
  AdditionalDropItemWhenPlayerKillingInPvPMode_Item: '物品',
  AdditionalDropItemWhenPlayerKillingInPvPMode_ItemAndEquipment: '物品和裝備',
  AdditionalDropItemWhenPlayerKillingInPvPMode_All: '全部',
  AdditionalDropItemNumWhenPlayerKillingInPvPMode: 'PvP 擊殺掉落數量',
  bDisplayPvPItemNumOnWorldMap_BaseCamp: '地圖顯示 PvP 物品（據點）',
  bDisplayPvPItemNumOnWorldMap_Player: '地圖顯示 PvP 物品（玩家）',
  bAllowClientMod: '允許客戶端模組',
  ChatPostLimitPerMinute: '每分鐘聊天訊息限制',
  LogFormatType: '日誌格式',
  LogFormatType_Text: '文字',
  LogFormatType_Json: 'Json',
  ItemContainerForceMarkDirtyInterval: '容器同步間隔',
  DenyTechnologyList: '禁用科技列表',
  DenyTechnologyListPlaceholder: '輸入以逗號分隔的科技 ID',
  // PalDefender Commands
  WhitelistAdd: '新增到白名單',
  WhitelistAddDesc: '將 ${1} 新增到伺服器白名單',
  RenamePlayer: '重新命名玩家',
  RenamePlayerDesc: '變更 ${1} 的名稱',
  TeleportPlayer: '傳送玩家',
  TeleportPlayerDesc: '將 ${1} 傳送到另一位玩家',
  GodMode: '無敵模式',
  GodModeDesc: '切換 ${1} 的無敵模式',
  ClearInventory: '清空背包',
  ClearInventoryDesc: '清空 ${1} 背包中的所有物品',
  ClearInventoryConfirm: '確定要清空背包嗎？',
  DeletePals: '刪除帕魯',
  DeletePalsDesc: '刪除 ${1} 的所有帕魯',
  DeletePalsConfirm: '確定要刪除所有帕魯嗎？',
  LearnTech: '學習科技',
  LearnTechDesc: '為 ${1} 解鎖一項科技',
  SpawnPal: '生成帕魯',
  SpawnPalDesc: '為 ${1} 生成一隻帕魯',
  GiveEgg: '給予蛋',
  GiveEggDesc: '給予 ${1} 一顆帕魯蛋',
  ReloadConfig: '重新載入設定',
  ReloadConfigDesc: '重新載入 PalDefender 設定',
  AddAdminIP: '新增管理員 IP',
  PgBroadcast: 'PalGuard 廣播',
  WhitelistManagement: '白名單管理',
  WhitelistManagementDesc: '管理 PalDefender 白名單。僅白名單中的玩家可以加入伺服器。',
